...
func (x *VesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VesResponse) ProtoMessage() {}

func (x *VesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_vessel_vessel_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VesResponse.ProtoReflect.Descriptor instead.
func (*VesResponse) Descriptor() ([]byte, []int) {
	return file_proto_vessel_vessel_proto_rawDescGZIP(), []int{2}
}

func (x *VesResponse) GetVessel() *Vessel {
	if x != nil {
		return x.Vessel
	}
	return nil
...
func (x *VesResponse) GetVessels() []*Vessel {
	if x != nil {
		return x.Vessels
	}
	return nil
...
func (x *VesResponse) GetCreated() bool {
	if x != nil {
		return x.Created
	}
	return false
...
var file_proto_vessel_vessel_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x73, 0x65, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa0, 0x01, 0x0a, 0x06,
	...
	,
}
...
var file_proto_vessel_vessel_proto_goTypes = []interface{}{
	(*Vessel)(nil),        // 0: Vessel
	(*Specification)(nil), // 1: Specification
	(*VesResponse)(nil),   // 2: VesResponse
}
var file_proto_vessel_vessel_proto_depIdxs = []int32{
	0, // 0: VesResponse.vessel:type_name -> Vessel
	0, // 1: VesResponse.vessels:type_name -> Vessel
	1, // 2: VesselService.FindAvailable:input_type -> Specification
	0, // 3: VesselService.Create:input_type -> Vessel
	2, // 4: VesselService.FindAvailable:output_type -> VesResponse
	2, // 5: VesselService.Create:output_type -> VesResponse
